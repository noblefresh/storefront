...
import {
  ...
  import "./ModalLayout.tsx"
  
  const appId = '8H2M3V30O4';
  const apiKey = 'fa2e56e5c8de1b673794487ff7d3e3f0';
      ...
      <div className="relative z-[80]">  
        <a href={hit.url} className="aa-ItemLink">
            ...
            <div className="aa-ItemIcon aa-ItemIcon--picture aa-ItemIcon--alignTop">
                {/* <img src={hit.thumbnail} alt={hit.title} width="40" height="40" /> */}
            </div>
            <div className="aa-ItemContentBody">
                ...
                From <strong>{hit.description}</strong> in{' '}
